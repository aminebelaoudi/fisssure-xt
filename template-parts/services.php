...
<section class="sec" id="services">
  <div class="cont">
    <div class="shead">
      <span class="stag"><?php esc_html_e( 'Nos spécialités', 'fissuredrainxt' ); ?></span>
      <h2 class="sh"><?php esc_html_e( 'Solutions complètes', 'fissuredrainxt' ); ?><br><?php esc_html_e( 'pour votre fondation', 'fissuredrainxt' ); ?></h2>
      <div class="sline"></div>
      <p class="sp" style="margin-top:16px"><?php esc_html_e( 'Chaque intervention est réalisée par des spécialistes certifiés RBQ, avec les matériaux les plus durables du marché québécois.', 'fissuredrainxt' ); ?></p>
    </div>
    <div class="vgrid">
