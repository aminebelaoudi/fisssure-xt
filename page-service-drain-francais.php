...
<section class="sec sec-dk">
  <div class="cont">
    <div class="shead c">
      <span class="stag"><?php esc_html_e( 'Pourquoi nous choisir', 'fissuredrainxt' ); ?></span>
      <h2 class="sh lt"><?php esc_html_e( 'Ce qui nous distingue', 'fissuredrainxt' ); ?><br><span style="color:var(--y)"><?php esc_html_e( 'pour votre drain', 'fissuredrainxt' ); ?></span></h2>
      <div class="sline c"></div>
    </div>
    <div class="prgrid">
      <div class="prcard">
        ...
        <span class="prstep"><?php esc_html_e( 'Spécialistes dédiés', 'fissuredrainxt' ); ?></span>
        <h4 class="prt"><?php esc_html_e( 'Pas des généralistes', 'fissuredrainxt' ); ?></h4>
        <p class="prd"><?php esc_html_e( 'Nous ne faisons que du drainage et de la réparation de fondation. Notre expertise ciblée garantit un résultat durable et conforme aux normes.', 'fissuredrainxt' ); ?></p>
      </div>
      <div class="prcard">
        <div class="prbar"></div>
        <span class="prnum">02</span>
        <span class="prstep"><?php esc_html_e( 'Matériaux durables', 'fissuredrainxt' ); ?></span>
        <h4 class="prt"><?php esc_html_e( 'Qualité avant prix', 'fissuredrainxt' ); ?></h4>
        <p class="prd"><?php esc_html_e( 'Nous utilisons des tuyaux perforés triple paroi, géotextile premium et pierre drainante lavée — pas de compromis sur la longévité.', 'fissuredrainxt' ); ?></p>
      </div>
      <div class="prcard">
        <div class="prbar"></div>
        <span class="prnum">03</span>
        <span class="prstep"><?php esc_html_e( 'Garantie 25 ans', 'fissuredrainxt' ); ?></span>
        <h4 class="prt"><?php esc_html_e( 'Engagement écrit', 'fissuredrainxt' ); ?></h4>
        <p class="prd"><?php esc_html_e( 'Notre garantie de 25 ans est transférable au nouveau propriétaire. Un document officiel remis à la fin des travaux.', 'fissuredrainxt' ); ?></p>
      </div>
      <div class="prcard">
        <div class="prbar"></div>
        <span class="prnum">04</span>
        <span class="prstep"><?php esc_html_e( 'Chantier propre', 'fissuredrainxt' ); ?></span>
        <h4 class="prt"><?php esc_html_e( 'Respect de votre terrain', 'fissuredrainxt' ); ?></h4>
        <p class="prd"><?php esc_html_e( 'Nous protégeons gazon, arbres et aménagement. Le terrain est remis en état impeccable après chaque intervention.', 'fissuredrainxt' ); ?></p>
      </div>
    </div>
  </div>
</section>
